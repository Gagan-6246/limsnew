const MENU_ITEMS = [
    ...
    { role: 'Admin', key: 'apps', label: 'Apps', isTitle: true },
    {
        role: 'Admin',
        key: 'apps-settings',
        label: 'Settings',
        ...
        children: [
            {
                key: 'settings-labdepartments',
                label: 'Lab Departments',
                url: '/apps/settings/labdepartments',
                parentKey: 'apps-settings',
            },
            {
                key: 'settings-analysisCategory',
                label: 'Analysis Category',
                url: '/apps/settings/analysisCategory',
                parentKey: 'apps-settings',
            },
            {
                key: 'settings-analysisService',
                label: 'Analysis Service',
                url: '/apps/settings/analysisService',
                parentKey: 'apps-settings',
            },
            {
            ...
            {
                key: 'settings-labcontact',
                label: 'Lab Contact',
                url: '/apps/settings/labcontact',
                parentKey: 'apps-settings',
            },

            {
                key: 'settings-Sample',
                label: 'Sample',
                url: '/apps/settings/Sample',
                parentKey: 'apps-settings',
            },
            {
                key: 'settings-enquiry',
                label: 'Enquiry',
                url: '/apps/settings/enquiry',
                parentKey: 'apps-settings',
            },
            {
                key: 'settings-orders',
                label: 'Orders',
                url: '/apps/settings/orders',
                parentKey: 'apps-settings',
            },
            {
                key: 'settings-users',
